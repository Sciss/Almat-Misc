...
import scala.swing.{Action, BorderPanel, BoxPanel, Button, Component, FlowPanel, Frame, Graphics2D, Label, Menu, MenuBar, MenuItem, Orientation, Rectangle, ScrollPane, Swing, ToggleButton}

object AdjustImages {
  val fBase : File = userHome / "Pictures" /"2015"/"12"/"07"
  val fBase2: File = userHome / "Documents" / "projects" / "Unlike" / "moor_8024"

  def main(args: Array[String]): Unit = Swing.onEDT(AdjustImages.mkFrame())
